...
namespace BasePaySdk.Request
{
     ...
     * @Description
     */
    public class V2LlaWithholdRefundQueryRequest : BaseRequest
    {
        ...
        public override string getFunctionCode() {
            return FunctionCodeEnum.V2_LLA_WITHHOLD_REFUND_QUERY;
        }

        public V2LlaWithholdRefundQueryRequest() {
        }

        public V2LlaWithholdRefundQueryRequest(string reqSeqId, string reqDate, string orgReqDate, string orgReqSeqId, string orgHfSeqId, string agencyHuifuId) {
