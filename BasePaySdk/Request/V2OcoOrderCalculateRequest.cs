...
namespace BasePaySdk.Request
{
     ...
     * @Description
     */
    public class V2OcoOrderCalculateRequest : BaseRequest
    {
        ...
        public V2OcoOrderCalculateRequest() {
        }

        public V2OcoOrderCalculateRequest(string reqSeqId, string reqDate, string huifuId, string busiSource, string ocoOrderId) {
