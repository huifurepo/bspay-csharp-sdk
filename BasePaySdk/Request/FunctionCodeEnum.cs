...
namespace BasePaySdk.Request
{
    public class FunctionCodeEnum
    {
         ...
         * 提现记录查询
         */
        public const string V2_LLA_DYWITHDRAW_QUERY = "v2.lla.dywithdraw.query";
        /**
         * 代运营代扣业务配置查询
         */
        public const string V2_MERCHANT_BUSI_LLADETAIL = "v2.merchant.busi.lladetail";
        /**
         * 代运营代扣业务配置
         */
        public const string V2_MERCHANT_BUSI_LLACONFIG = "v2.merchant.busi.llaconfig";
        /**
         * 代运营佣金代扣退款查询
         */
        public const string V2_LLA_WITHHOLD_REFUND_QUERY = "v2.lla.withhold.refund.query";
        /**
         * 代运营佣金代扣退款
         */
        public const string V2_LLA_WITHHOLD_REFUND = "v2.lla.withhold.refund";
        /**
         * 代运营佣金代扣查询
         */
        public const string V2_LLA_WITHHOLD_QUERY = "v2.lla.withhold.query";
        /**
         * 代运营佣金代扣
         */
        public const string V2_LLA_WITHHOLD = "v2.lla.withhold";
        /**
         * 灵工支付退款查询
         */
        public const string V2_FLEXIBLE_REFUND_QUERY = "v2.flexible.refund.query";
        /**
         * 灵工支付退款
         */
        public const string V2_FLEXIBLE_REFUND = "v2.flexible.refund";
        /**
         * 灵工支付查询
         */
        public const string V2_FLEXIBLE_TRADE_QUERY = "v2.flexible.trade.query";
        /**
         * 灵工支付
         */
        public const string V2_FLEXIBLE_TRADE = "v2.flexible.trade";
        /**
         * 灵工企业商户业务修改
         */
        public const string V2_FLEXIBLE_ENT_MODIFY = "v2.flexible.ent.modify";
        /**
         * 灵工企业商户进件接口
         */
        public const string V2_FLEXIBLE_ENT = "v2.flexible.ent";
        /**
         * 灵工企业商户信息查询
         */
        public const string V2_FLEXIBLE_ENT_QUERY = "v2.flexible.ent.query";
        /**
         * 灵工个人用户修改
         */
        public const string V2_FLEXIBLE_INDV_MODIFY = "v2.flexible.indv.modify";
        /**
         * 灵工个人用户进件
         */
        public const string V2_FLEXIBLE_INDV = "v2.flexible.indv";
        /**
         * 灵工用户信息查询
         */
        public const string V2_FLEXIBLE_INDV_QUERY = "v2.flexible.indv.query";
        /**
         * 电子账户资金清分
         */
        public const string V2_TRADE_SETTLEMENT_CLEARING_ADD = "v2.trade.settlement.clearing.add";
        /**
         * 电子账户资金清分结果查询
         */
        public const string V2_TRADE_SETTLEMENT_CLEARING_QUERY = "v2.trade.settlement.clearing.query";
        /**
         * 全渠道订单分账明细操作
         */
        public const string V2_OCO_ORDER_DETAIL_OPERATE = "v2.oco.order.detail.operate";
        /**
         * 全渠道订单分账接收方查询
         */
        public const string V2_OCO_ORDER_DETAIL_LIST = "v2.oco.order.detail.list";
        /**
         * 全渠道订单分账计算
         */
        public const string V2_OCO_ORDER_CALCULATE = "v2.oco.order.calculate";
        /**
         * 获取控台页面跳转链接
         */
        public const string V2_JUMP_PAGE_GETURL = "v2.jump.page.geturl";
        /**
         * 全渠道订单分账查询
         */
        public const string V2_OCO_ORDER_LIST = "v2.oco.order.list";
        /**
         * 美团卡券校验
         */
        public const string V2_COUPON_MEITUAN_PREPARE = "v2.coupon.meituan.prepare";
        /**
         * 美团卡券核销结果查询
         */
        public const string V2_COUPON_MEITUAN_QUERY = "v2.coupon.meituan.query";
        /**
         * 美团卡券核销
         */
        public const string V2_COUPON_MEITUAN_CONSUME = "v2.coupon.meituan.consume";
        /**
         * 美团卡券撤销
         */
        public const string V2_COUPON_MEITUAN_CANCEL = "v2.coupon.meituan.cancel";
        /**
         * 美团餐饮门店套餐映射
         */
        public const string V2_COUPON_MEAL_QUERY = "v2.coupon.meal.query";
        /**
         * 三方门店解绑
         */
        public const string V2_LINKAPP_STORE_UNBIND = "v2.linkapp.store.unbind";
        /**
         * 三方门店查询（三方门店绑定一阶段）
         */
        public const string V2_LINKAPP_STORE_SHOPLIST = "v2.linkapp.store.shoplist";
        /**
         * 三方门店绑定（二阶段）
         */
        public const string V2_LINKAPP_STORE_BIND = "v2.linkapp.store.bind";
        /**
         * 门店绑定列表查询
         */
        public const string V2_LINKAPP_STORE_QUERY = "v2.linkapp.store.query";
        /**
         * 美团非餐饮获取团购信息
         */
        public const string V2_COUPON_SHOPDEAL_QUERY = "v2.coupon.shopdeal.query";
        /**
         * 授权结果查询
         */
        public const string V2_LINKAPP_AUTH_RESULT = "v2.linkapp.auth.result";
        /**
         * 商户公域授权
         */
        public const string V2_LINKAPP_AUTH_DO = "v2.linkapp.auth.do";
        /**
         * 查询授权记录
         */
        public const string V2_LINKAPP_AUTH_QUERY = "v2.linkapp.auth.query";
        /**
         * 抖音套餐映射接口
         */
        public const string V2_COUPON_DOUYIN_PRODUCT_QUERY = "v2.coupon.douyin.product.query";
        /**
         * 抖音券状态批量查询
         */
        public const string V2_COUPON_DOUYIN_CERTIFICATE_QUERY = "v2.coupon.douyin.certificate.query";
        /**
         * 抖音卡券校验
         */
        public const string V2_COUPON_DOUYIN_PREPARE = "v2.coupon.douyin.prepare";
        /**
         * 抖音卡券核销
         */
        public const string V2_COUPON_DOUYIN_CONSUME = "v2.coupon.douyin.consume";
        /**
         * 抖音卡券撤销
         */
        public const string V2_COUPON_DOUYIN_CANCEL = "v2.coupon.douyin.cancel";
        /**
         * 银行大额支付固定转账标识申请接口
         */
        public const string V2_TRADE_ONLINEPAYMENT_TRANSFER_FIXEDFLAG_APPLY = "v2.trade.onlinepayment.transfer.fixedflag.apply";
        /**
         * 电子账户付款查询
         */
        public const string V2_TRADE_PAYMENT_ZXE_ACCTPYERQUERY = "v2.trade.payment.zxe.acctpyerquery";
        /**
         * 电子账户付款
         */
        public const string V2_TRADE_PAYMENT_ZXE_ACCTPYER = "v2.trade.payment.zxe.acctpyer";
        /**
         * 银联统一在线收银台签解约查询接口
         */
         ...
         * 防断链子商户号列表查询
         */
        public const string V2_MERCHANT_ATPREVENT_QUERYSUBMERLIST = "v2.merchant.atPrevent.querySubMerList";
        /**
         * 防断链入驻
         */
        public const string V2_MERCHANT_ATPREVENT_APPLY = "v2.merchant.atPrevent.apply";
        /**
         * 全渠道资金提现申请
         */
        public const string V2_EFP_ENCASH = "v2.efp.encash";
        /**
         * 全渠道资金付款提现记录查询
         */
        public const string V2_EFP_WITHDRAW_QUERY = "v2.efp.withdraw.query";
        /**
         * 全渠道资金付款申请
         */
        public const string V2_EFP_SURROGATE = "v2.efp.surrogate";
        /**
         * 托管交易关单
         */
        public const string V2_TRADE_HOSTING_PAYMENT_CLOSE = "v2.trade.hosting.payment.close";
        /**
         * 取现
         */
        public const string V2_TRADE_SETTLEMENT_ENCASHMENT = "v2.trade.settlement.encashment";
        /**
         * 红字发票开具接口
         */
        public const string V2_INVOICE_REDOPEN = "v2.invoice.redopen";
        /**
         * 交易确认查询
         */
