...
namespace BasePayDemo
{
    ...
    public class V2MerchantBasicdataModifyRequestDemo
    {
        ...
        public static void V2MerchantBasicdataModifyRequestDemoTest()
        {
            ...
            // request.setSignUserInfo(get791c67b3Cce741158ece6eaaf530de10());
        ...
        private static Dictionary<string, object> getExtendInfos() {
            ...
            // *结算卡信息配置*
            extendInfoMap.Add("card_info", get3734abd86fec448dB3eeB2650b1e468c());
            // 结算协议图片文件
            // extendInfoMap.Add("settle_agree_pic", "");
            // 基本存款账户编号或核准号
            // extendInfoMap.Add("open_licence_no", "");
            // 取现信息配置
            extendInfoMap.Add("cash_config", getD8f62ec88c7340c8A8fe98e6be019538());
            // 结算规则配置
            extendInfoMap.Add("settle_config", getBc88ac225ddb46a885bf7be8310e4a4f());
            // 商户主页URL
            // extendInfoMap.Add("mer_url", "");
            // 商户ICP备案编号
            // extendInfoMap.Add("mer_icp", "");
            // 受益人列表
            // extendInfoMap.Add("beneficiary_info", getB31f324178ea4ab5Bac8Df1e67a566f2());
            // 协议信息
            // extendInfoMap.Add("agreement_info", getDc09f955A7824544Aed2D92480b74027());
            // 营业执照图片
            ...
            // 扩展资料包
            // extendInfoMap.Add("extended_material_list", get457c26e1370646d085ea7a5cb2f3dc6e());
            // 异步通知地址
            extendInfoMap.Add("async_return_url", "archer://C_SSPM_NSPOSM_BUSIRESULT");
            // 斗拱e账户功能配置
            // extendInfoMap.Add("elec_acct_config", get0c17625068a141abAe810df61d8514a4());
            // 股东信息
            // extendInfoMap.Add("share_holder_info_list", get03750dcb69b84148Ac0b225a1f2446d2());
            // 外部商户号
        ...
        private static string get3734abd86fec448dB3eeB2650b1e468c() {
        ...
        private static string getD8f62ec88c7340c8A8fe98e6be019538() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 状态
        ...
        private static string getBc88ac225ddb46a885bf7be8310e4a4f() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 结算开关
        ...
        private static string getB31f324178ea4ab5Bac8Df1e67a566f2() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 受益人名称
        ...
        private static string get791c67b3Cce741158ece6eaaf530de10() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 签约人类型
            // obj.Add("type", "test");
            // 姓名
        ...
        private static string getDc09f955A7824544Aed2D92480b74027() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 协议类型
        ...
        private static string get457c26e1370646d085ea7a5cb2f3dc6e() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 文件id
        ...
        private static object get6365130a554b468e8b227b293f0e7757() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 银行编码
        ...
        private static string get0c17625068a141abAe810df61d8514a4() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 电子账户开关
            ...
            // 银行卡信息
            // obj.Add("elec_card_list", get6365130a554b468e8b227b293f0e7757());

            return JsonConvert.SerializeObject(obj);
        }
        private static string get03750dcb69b84148Ac0b225a1f2446d2() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 股东姓名
            // obj.Add("name", "test");
            // 股东证件类型
