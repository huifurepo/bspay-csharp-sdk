...
namespace BasePayDemo
{
    ...
    public class V2WalletCreateRequestDemo
    {
        ...
        private static Dictionary<string, object> getExtendInfos() {
            ...
            // 实名验证信息
            extendInfoMap.Add("real_name_veri_info", getDd8b4ee218634d47Ba4c37c34ccd5b31());
            // 风险验证方式
        ...
        private static string get9e6d80e68292401a810e1570231010f6() {
            ...
            // 设备信息域
            obj.Add("trx_device_info", get2168fcfd89724371B0c2Ac35d6c5e564());
            // 银行卡类型
            obj.Add("dc_type", "D");
            // 风控信息
            obj.Add("risk_info", getD8d893a20b24463c80ecC5a6f6543239());
        ...
        private static string getDd8b4ee218634d47Ba4c37c34ccd5b31() {
            ...
            // 钱包绑定卡信息
            obj.Add("bind_card_info", get9e6d80e68292401a810e1570231010f6());
