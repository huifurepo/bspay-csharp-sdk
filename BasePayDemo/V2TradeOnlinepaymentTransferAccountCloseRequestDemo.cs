...
namespace BasePayDemo
{
     ...
     * @Description
     */
    public class V2TradeOnlinepaymentTransferAccountCloseRequestDemo
    {

        public static void V2TradeOnlinepaymentTransferAccountCloseRequestDemoTest()
        {
            ...
            // 2.组装请求参数
            V2TradeOnlinepaymentTransferAccountCloseRequest request = new V2TradeOnlinepaymentTransferAccountCloseRequest();
            // 请求流水号
        ...
        private static Dictionary<string, object> getExtendInfos() {
            ...
            // 入账标识
            extendInfoMap.Add("in_acct_flag", "YDNUCSV2JV7BAXYN");
