...
namespace BasePayDemo
{
    ...
    public class V2MerchantBusiModifyRequestDemo
    {
        ...
        public static void V2MerchantBusiModifyRequestDemoTest()
        {
            ...
            // request.setSignUserInfo(get481cce133bfe4925B2f7488cd9af15ea());
        ...
        private static Dictionary<string, object> getExtendInfos() {
            ...
            // *协议信息实体*
            extendInfoMap.Add("agreement_info", get6121347a73db43b38f70C327d8a3042b());
            // 是否交易手续费外扣
            ...
            // 线上费率配置
            // extendInfoMap.Add("online_fee_conf_list", get82ad42dcC89d4cc5Abb56891ada03862());
            // 支付宝配置对象
            extendInfoMap.Add("ali_conf_list", get4c10cf4aBc5d4a158889Af80469f24ce());
            // 微信配置对象
            extendInfoMap.Add("wx_conf_list", get9d7afd7071d94016Bd29A0200a3dd11c());
            // 银联二维码配置对象
            extendInfoMap.Add("union_conf_list", getB7c7780c56f54d7eA0ddC78e7faf92d0());
            // 银行卡支付配置信息
            extendInfoMap.Add("bank_card_conf", get7c67d4274fd64af8Aab2E76cd8c336b6());
            // *余额支付配置对象*
            extendInfoMap.Add("balance_pay_config", getAf2f49ca75e04830B0e33208518f3761());
            // 补贴支付
            extendInfoMap.Add("combine_pay_config", getBbeec74526b648828b151782d3d42201());
            // 线上手续费承担方配置
            // extendInfoMap.Add("online_pay_fee_conf_list", get39dca475E388493481fd5f3e72565ff3());
            // 全域资金管理配置(华通银行)
            // extendInfoMap.Add("out_order_funds_config", get7d81b1b5Ab104e2199d7A85d9455b7fe());
            // 汇总结算配置实体
            // extendInfoMap.Add("collection_settle_config_list", get35ccae80A45b4ed4Aa4bC2a789a5d75a());
            // 异步消息接收地址
            ...
            // *运营媒介*
            // extendInfoMap.Add("online_media_info_list", get3d8a7d748b26495f83788946dac755fa());
            // *补充文件信息*
            // extendInfoMap.Add("extended_material_list", get3565b3581d9546bf9624C09646528f11());
            // 商户开通强制延迟标记
            // extendInfoMap.Add("forced_delay_flag", "");
            // 微信直连配置对象
            // extendInfoMap.Add("wx_zl_conf", getB9dbcd4334d04c74913eA5f58b11931d());
            // 支付宝直连配置对象
            // extendInfoMap.Add("ali_zl_conf", get49ccd1fe51a645a8A956B70a25a5fd86());
            // 开户费用值(元)
            ...
            // 分账配置信息
            // extendInfoMap.Add("split_conf_info", getA54c67b8514b42bb87c813df7651a81a());
            // 银联线上收银台
            // extendInfoMap.Add("uni_app_payment_config", get715aba0e4c8743849db5F94f5616a5cc());
            // 资金归集开通标记
            // extendInfoMap.Add("fund_collection_flag", "");
            // 代发配置
            // extendInfoMap.Add("surrogate_config_list", get3f750bfb7fe84c2d97c4Ad100c7c3570());
            // 大额支付配置
            // extendInfoMap.Add("large_amt_pay_config", get0f3cba59909442259e55Fcc95c6bf717());
            // 托管支付开关
            // extendInfoMap.Add("half_pay_host_flag", "");
            // 代发复核配置
            // extendInfoMap.Add("agent_recheck_config", getCe7159bcCd8b4566Be61225d04027497());
            // 商户开通网银充值开关
            // extendInfoMap.Add("online_recharge_flag", "");
            return extendInfoMap;
        }

        private static string get6121347a73db43b38f70C327d8a3042b() {
        ...
        private static string get82ad42dcC89d4cc5Abb56891ada03862() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 业务类型
        ...
        private static string get344a3e89E4c94ec49a6957406a249ed9() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 联系人身份证号码
        ...
        private static string getA6475accCe2a4fb59758B586f85d1ef6() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 证件持有人类型
            // obj.Add("legal_type", "");
            // 证件类型
        ...
        private static string get6b3bab2895184e03Bb992795cc8d2923() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 是否金融机构
            ...
            // 联系人信息对象
            // obj.Add("contact_person_info", get344a3e89E4c94ec49a6957406a249ed9());
            // 法人身份信息
            // obj.Add("legal_person_info", getA6475accCe2a4fb59758B586f85d1ef6());

            return JsonConvert.SerializeObject(obj);
        }
        private static string get4c10cf4aBc5d4a158889Af80469f24ce() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 手续费（%）
            ...
            // 实名认证信息
            // obj.Add("al_real_name_info", get6b3bab2895184e03Bb992795cc8d2923());

            JArray objList = new JArray();
            objList.Add(JToken.FromObject(obj));
            return JsonConvert.SerializeObject(objList);
        }
        private static object getD80ec06a4e764bfdBa223758a08c4999() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
        ...
        private static string get9d7afd7071d94016Bd29A0200a3dd11c() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 开关状态
            // obj.Add("switch_state", "test");
            // 手续费（%）
            ...
            // obj.Add("is_check_real_name", "");
            // 实名认证信息
            // obj.Add("wx_real_name_info", getD80ec06a4e764bfdBa223758a08c4999());

            JArray objList = new JArray();
            objList.Add(JToken.FromObject(obj));
            return JsonConvert.SerializeObject(objList);
        }
        private static string getB7c7780c56f54d7eA0ddC78e7faf92d0() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 借记卡手续费（%）
        ...
        private static string get7c67d4274fd64af8Aab2E76cd8c336b6() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 借记卡手续费（%）
        ...
        private static object get630eac8aA0a346d9B550472bf19d54f5() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // *业务模式说明*
        ...
        private static string getAf2f49ca75e04830B0e33208518f3761() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // *业务模式*
            // obj.Add("balance_model", "test");
            // *业务情况说明*
            // obj.Add("description_info", get630eac8aA0a346d9B550472bf19d54f5());
            // 支付手续费(%)
            obj.Add("fee_rate", "2");
            // 支付固定手续费(元)
        ...
        private static string getBbeec74526b648828b151782d3d42201() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 功能开关
        ...
        private static string get39dca475E388493481fd5f3e72565ff3() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 业务类型
            // obj.Add("pay_type", "");
        ...
        private static object get337fa4d8035e417792bb3fff2c965fa0() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 结算账户名
        ...
        private static object get76b6f5ff1a95498eA84e9a5cbd8fe133() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 开户手续费(元)
        ...
        private static string get7d81b1b5Ab104e2199d7A85d9455b7fe() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 功能开关
            // obj.Add("switch_state", "test");
            // 自动入账开关
            ...
            // obj.Add("out_fee_huifuid", "");
            // 全域资金开户使用的银行卡信息
            // obj.Add("out_order_acct_card", get337fa4d8035e417792bb3fff2c965fa0());
            // 全域资金开户手续费
            // obj.Add("out_order_acct_open_fees", get76b6f5ff1a95498eA84e9a5cbd8fe133());
            // 全域支付业务模式
            // obj.Add("business_model", "");

            return JsonConvert.SerializeObject(obj);
        }
        private static string get35ccae80A45b4ed4Aa4bC2a789a5d75a() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 归集留存金(元)
        ...
        private static string get3d8a7d748b26495f83788946dac755fa() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // *运营媒介类型*
        ...
        private static string get3565b3581d9546bf9624C09646528f11() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // *文件id*
        ...
        private static string get481cce133bfe4925B2f7488cd9af15ea() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 签约人类型
            // obj.Add("type", "test");
        ...
        private static object getF37afda41665454484213559cfa9b5fb() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 文件类型
        ...
        private static object getBde5314d5fef4e239ea3Bcfc2c2a8b69() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 联系人类型
            ...
            // obj.Add("contact_file_list", getF37afda41665454484213559cfa9b5fb());
            // 证件有效期类型
        ...
        private static object getB7dbd856B29f4a1dB675A8a73145b38d() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 文件类型
            // obj.Add("file_type", "test");
            // 文件jfileId
        ...
        private static object getB730892aD7dc4d3690d0F82d0acc366b() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 登记证书类型
            // obj.Add("cert_type", "test");
            // 证书号
            ...
            // obj.Add("cert_begin_date", "test");
            // 文件列表
            // obj.Add("cert_file_list", getB7dbd856B29f4a1dB675A8a73145b38d());
            // 证书有效期截止日期
            // obj.Add("cert_end_date", "");

            return obj;
        }
        private static object getE985d16f51984c20843b4f5ac83e9184() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 文件类型
            // obj.Add("file_type", "test");
            // 文件jfileId
        ...
        private static object get7fc3208a0d844a5cA3de5e71ada8a838() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 证件类型
            ...
            // 文件列表
            // obj.Add("ubo_file_list", getE985d16f51984c20843b4f5ac83e9184());
            // 证件有效期截止日期
        ...
        private static object get2dd579b49ef94813B4bc3d4790699125() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 经营者/法人是否为受益人
            // obj.Add("ubo_type", "test");
            // 受益人信息列表jsonArray格式,当ubo_type为Y时可不填
            // obj.Add("ubo_info_list", get7fc3208a0d844a5cA3de5e71ada8a838());

            return obj;
        }
        private static object getAbd9022dA936424a94c1D50a661847e1() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 文件类型
            // obj.Add("file_type", "test");
            // 文件jfileId
        ...
        private static object get88851f2bC10f47a2BbaaCc32fe00657c() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 经营场景类型
            ...
            // 文件列表
            // obj.Add("sales_scenes_file_list", getAbd9022dA936424a94c1D50a661847e1());
            // 文件列表
        ...
        private static object get485894caF00e40bb99df846af75658bb() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 账户类型
            // obj.Add("card_type", "test");
            // 开户名称
        ...
        private static object getC16cd41c290b4f9aAe260bb5e5c33385() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 文件类型
            // obj.Add("file_type", "test");
            // 文件jfileId
        ...
        private static object get53445ee8966a4d7e8b58927b1912102a() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 申请服务
            ...
            // obj.Add("contact_info", getBde5314d5fef4e239ea3Bcfc2c2a8b69());
            // 特殊主体登记证书jsonObject字符串，商户营业执照类型为政府机关/事业单位/其他组织时，传入相应信息。新增时需填入
            // obj.Add("certificate_info", getB730892aD7dc4d3690d0F82d0acc366b());
            // 最终受益人信息jsonObject字符串，商户类型为企业时，微信侧必填。（如果基本信息里有的话，可以不传取 huifu_id 对应的信息）。新增时填入
            // obj.Add("ubo_info", get2dd579b49ef94813B4bc3d4790699125());
            // 经营场景jsonObject字符串，新增时填入
            // obj.Add("sales_info", get88851f2bC10f47a2BbaaCc32fe00657c());
            // 银行账户信息jsonObject字符串，该字段不填时，取商户在汇付系统录入的结算账号信息。新增或修改时填入，修改时必填
            // obj.Add("wx_card_info", get485894caF00e40bb99df846af75658bb());
            // 补充说明信息
            // obj.Add("business_addition_msg", "");
            // 补充说明文件列表
            // obj.Add("addition_file_list", getC16cd41c290b4f9aAe260bb5e5c33385());

            JArray objList = new JArray();
            objList.Add(JToken.FromObject(obj));
            return objList;
        }
        private static string getB9dbcd4334d04c74913eA5f58b11931d() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 微信子商户号
            // obj.Add("sub_mch_id", "test");
            // 配置集合
            // obj.Add("wx_zl_pay_conf_list", get53445ee8966a4d7e8b58927b1912102a());

            return JsonConvert.SerializeObject(obj);
        }
        private static object get7cf3c2108a054210A471B0347a15ce11() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 文件类型
            // obj.Add("file_type", "test");
            // 文件jfileId
        ...
        private static string get49ccd1fe51a645a8A956B70a25a5fd86() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 申请类型
            ...
            // obj.Add("fee_rate", "test");
            // 文件列表
            // obj.Add("file_list", get7cf3c2108a054210A471B0347a15ce11());
            // 联系人姓名
        ...
        private static object get4ddf282836284c97Af2081a556607102() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 分账比例
            // obj.Add("fee_rate", "test");
            // 汇付Id
        ...
        private static object get8bff25f0A02a46d0Bd320b7633818e4b() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // *业务模式说明*
            // obj.Add("busi_instruction", "test");
            // *资金流向说明*
        ...
        private static string getA54c67b8514b42bb87c813df7651a81a() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 分账规则来源
            ...
            // obj.Add("scene", "test");
            // 分账明细
            // obj.Add("acct_split_bunch_list", get4ddf282836284c97Af2081a556607102());
            // 交易手续费外扣开关
            // obj.Add("out_fee_flag", "");
            // 交易手续费外扣时的账户类型
            // obj.Add("out_fee_acct_type", "");
            ...
            // obj.Add("per_amt", "");
            // 业务情况说明
            // obj.Add("split_ext_info", get8bff25f0A02a46d0Bd320b7633818e4b());

            return JsonConvert.SerializeObject(obj);
        }
        private static string get715aba0e4c8743849db5F94f5616a5cc() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
        ...
        private static string get3f750bfb7fe84c2d97c4Ad100c7c3570() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 代发业务类型
        ...
        private static object get1964d291Ab5048a483077985a4e2e871() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 大额支付业务模式
        ...
        private static string get0f3cba59909442259e55Fcc95c6bf717() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 大额支付配置列表
            // obj.Add("large_amt_pay_config_info_list", get1964d291Ab5048a483077985a4e2e871());
        ...
        private static object getCe7159bcCd8b4566Be61225d04027497() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 代发复核开关
