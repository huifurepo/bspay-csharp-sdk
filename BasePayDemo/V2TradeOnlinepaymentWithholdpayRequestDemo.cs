...
namespace BasePayDemo
{
    ...
    public class V2TradeOnlinepaymentWithholdpayRequestDemo
    {
        ...
        private static Dictionary<string, object> getExtendInfos() {
            ...
            // 分账对象
            // extendInfoMap.Add("acct_split_bunch", get581211bf56df4b98814aCdbda319724e());
            // 补贴支付信息
            // extendInfoMap.Add("combinedpay_data", get1d0fed46Cfd94d828be3354035b059ba());
            return extendInfoMap;
        }

        private static object getC775b270E79b4d7cAb26Efb8e716ad46() {
        ...
        private static string get581211bf56df4b98814aCdbda319724e() {
            Dictionary<string, object> obj = new Dictionary<string, object>();
            // 分账信息列表
            // obj.Add("acct_infos", getC775b270E79b4d7cAb26Efb8e716ad46());
            // 百分比分账标志
